...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--save_batch_freq', type=int, default=1024,
        ...
        parser.add_argument('--pretrained_model', type=str, default="/root/autodl-tmp/checkpoints/experiment_name/rnn_lip_model_epoch_5.pth", help='model will fine tune on it if fine-tune is True')
