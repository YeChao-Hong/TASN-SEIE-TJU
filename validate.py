...
if __name__ == "__main__":
    ...
    parser.add_argument("--real_list_path", type=str, default="/root/autodl-tmp/test_final/0_real")
    parser.add_argument("--fake_list_path", type=str, default="/root/autodl-tmp/test_final/1_fake")
