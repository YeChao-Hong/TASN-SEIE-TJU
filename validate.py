...
if __name__ == "__main__":
    ...
    parser.add_argument("--real_list_path", type=str, default="/root/autodl-tmp/val_036/0_real")
    parser.add_argument("--fake_list_path", type=str, default="/root/autodl-tmp/val_036/1_fake")
    ...
    parser.add_argument("--ckpt", type=str, default="/root/autodl-tmp/checkpoints/experiment_name/final_lip_model_epoch_1.pth")
